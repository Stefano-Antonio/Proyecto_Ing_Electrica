...
import AdministrarPersonalCoordinadorGen from './AdministrarPersonalCoordinadorGen';
import AdministrarMateriasCoordGen from './AdministrarMateriasCoordGen';


const InicioCoordGen = () => {
    ...
    return (
      ...
      <div className="coordinador-container">
        ...
        {componenteActivo === 'personal' && <AdministrarPersonalCoordinadorGen />}
        {componenteActivo === 'materias' && <AdministrarMateriasCoordGen />}
      </div>
    );
  };

export default InicioCoordGen;