  ...
  return (
    <div className="materia-layout">
      <div className="materia-container">
        ...
        <h1>{materia._id ? "Modificar materia" : "Agregar materia"}</h1>
        <div className="materia-content">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <div className="input-wrapper short-field">
                <label htmlFor="horarios-lunes">Lunes</label>
                <select
                  id="horarios-lunes"
              ...
              <div className="input-wrapper short-field">
                <label htmlFor="horarios-martes">Martes</label>
                <select
                  id="horarios-martes"
              ...
              <div className="input-wrapper short-field">
                <label htmlFor="horarios-miercoles">Miércoles</label>
                <select
              ...
              <div className="input-wrapper short-field">
                <label htmlFor="horarios-viernes">Viernes</label>
                <select
                  id="horarios-viernes"
            ...
            <div className="materia-buttons">
              <button type="submit" className="button">{materia._id ? "Actualizar" : "Agregar"}</button>
